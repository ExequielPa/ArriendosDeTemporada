...
//            System.out.println(dep.getEstado());
    ...
    public boolean eliminarDepto(Connection con, int id) {
        boolean pasoEliminar = false;
        String sql = "{call delete_dpto (?)}";
    ...
    public void listarDepto(Connection con, JTable tabla) {
        ...
        String [] columnas = {"ID", "N° Depto", "Direccion", "descripcion", "Region", "Estado"};
